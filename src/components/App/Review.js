...
const Review = () => {
  ...
  const getMovies = () => {
    callApiGetMovies()
      .then(res => {
        ...
        // const movieNames = Object.values(parsed).map(movie => movie.name);
        // setMovie(movieNames);
        // const movieNames = Object.values(parsed.name)
        // setMovie(movieNames);
        ...
        // const movie = Object.values(parsed).map(movie => movie.name);
        setMovie(parsed);
      })
      .catch(error => {
  ...
  const submitCheck = () =>{
    ...
    if (selectedMovie && enteredTitle && enteredReview && selectedRating) {
      ...
      // const review = {selectedMovie,enteredTitle,enteredReview,selectedRating}
      // setReview(review);
      setReview({
